...
public class Producto
{
    ...
    private final static double IVA_TEXTIL = 0.10;
    ...
    public double aumentarValorUnitario (){
        double iva = 0;
        if (calcularPrecioFinal() < 1){
            iva = darIVA() * 0.1;
        } else if ( calcularPrecioFinal() >= 1 && calcularPrecioFinal() <= 5){
            iva = darIVA() * 0.2;
        } else {
            iva = darIVA() * 0.3;
        }
